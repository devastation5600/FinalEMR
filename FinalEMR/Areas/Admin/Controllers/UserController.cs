...
namespace FinalEMR.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        {
            var userList = _db.ApplicationUsers.Include(u => u.Doctor).Include(m => m.Nurse).ToList();
            ...
            foreach (var user in userList)
            {
                ...
                if (user.Doctor == null)
                {
                    //So Doctor Value doesn't throw error when creating user as admin
                ...
                if (user.Nurse == null)
                {
                    //So Nurse Value doesn't throw error when creating user as admin
        ...
        public IActionResult LockUnlock([FromBody] string id)
        {
            ...
            {
                //user is curretly lockedout, we will unlock them
